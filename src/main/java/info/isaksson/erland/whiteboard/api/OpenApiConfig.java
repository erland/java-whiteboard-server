...
@OpenAPIDefinition(
        info = @Info(
                ...
                version = "1.0.0",
                description = "REST API for board management, snapshots, invites, publications, comments, assets, capability discovery, and identity lookups for the whiteboard server.",
