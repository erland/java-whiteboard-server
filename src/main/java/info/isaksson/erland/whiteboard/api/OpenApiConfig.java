...
@OpenAPIDefinition(
        info = @Info(
                ...
                version = "1.0.0",
                description = "REST API for board management, snapshots, invites, publications, comments, assets, voting, capability discovery, and identity lookups for the whiteboard server.",
        ...
        tags = {
                ...
                @Tag(name = "Voting", description = "Voting session lifecycle, vote submission, and results endpoints."),
                @Tag(name = "Identity", description = "Authenticated user identity and capability discovery endpoints.")
        }
)
@SecurityScheme(
